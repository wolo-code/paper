...
\begin{equation}\Delta^\textsuperscript{1}_\textsubscript{lng} = \frac{\pi}{180\degree} \ a \ cos \psi\end{equation}
where, \begin{equation}tan\psi = \frac{b}{a} \ tan\phi\end{equation}

Then the total span angle A\textsubscript{lng} for a resolution of 2m is given by:
\begin{equation}A\textsubscript{lng} = 2 \ \frac{N}{\Delta^\textsuperscript{1}_\textsubscript{lng}}\end{equation}
and
\begin{equation}\Delta\textsubscript{lng} = 2 \ \frac{1}{\Delta^\textsuperscript{1}_\textsubscript{lng}}\end{equation}
\\
...
\bibitem{b5} Wikipedia.org - Length of a degree of longitude \\
https://en.wikipedia.org/wiki/Longitude\#Length\_of\_a\_degree\_of\_longitude
\end{thebibliography}
