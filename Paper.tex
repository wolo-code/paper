...
Then the total span angle $\Theta$\textsubscript{lat} for a resolution of 2m is given by:
\begin{equation}\Theta\textsubscript{lat} = 2 \ \frac{N}{\Delta^\textsuperscript{1}_\textsubscript{lat}}\end{equation}
and the latitude angle spanning $\Delta$ becomes:
...
Then the total span angle $\Theta$\textsubscript{lng} for a resolution of 2m is given by:
\begin{equation}\Theta\textsubscript{lng} = 2 \ \frac{N}{\Delta^\textsuperscript{1}_\textsubscript{lng}}\end{equation}
and the longitude angle spanning $\Delta$ becomes:
